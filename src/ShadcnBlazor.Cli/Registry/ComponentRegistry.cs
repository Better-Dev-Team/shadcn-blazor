...
public static class ComponentRegistry
{
    public static readonly Dictionary<string, RegistryComponent> Components = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["toggle"] = new("toggle", "Pressed state button and toggle groups", Array.Empty<string>(), new[] { "Toggle/Toggle.razor", "Toggle/ToggleGroup.razor", "Toggle/ToggleGroupItem.razor" }),
