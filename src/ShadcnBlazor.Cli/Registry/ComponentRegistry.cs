...
public static class ComponentRegistry
{
    public static readonly Dictionary<string, RegistryComponent> Components = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["aspect-ratio"] = new("aspect-ratio", "Displays content within a desired ratio", Array.Empty<string>(), new[] { "AspectRatio/AspectRatio.razor" }),
        ["kbd"] = new("kbd", "Keyboard key indicator for showing shortcuts", Array.Empty<string>(), new[] { "Kbd/Kbd.razor" }),
        ["scroll-area"] = new("scroll-area", "Custom scrollable viewport with themed scrollbars", Array.Empty<string>(), new[] { "ScrollArea/ScrollArea.razor", "ScrollArea/ScrollBar.razor", "ScrollArea/ScrollOrientation.cs" }),
        ["hover-card"] = new("hover-card", "Hover card preview overlay", Array.Empty<string>(), new[] { "HoverCard/HoverCard.razor", "HoverCard/HoverCardTrigger.razor", "HoverCard/HoverCardContent.razor" }),
        ["drawer"] = new("drawer", "Modal drawer sliding up from screen edge", new[] { "button" }, new[] { "Drawer/Drawer.razor", "Drawer/DrawerTrigger.razor", "Drawer/DrawerContent.razor", "Drawer/DrawerHeader.razor", "Drawer/DrawerTitle.razor", "Drawer/DrawerDescription.razor", "Drawer/DrawerFooter.razor", "Drawer/DrawerClose.razor", "Drawer/DrawerDirection.cs" }),
        ["input-otp"] = new("input-otp", "Accessible one-time password pin input", Array.Empty<string>(), new[] { "InputOTP/InputOTP.razor", "InputOTP/InputOTPGroup.razor", "InputOTP/InputOTPSlot.razor", "InputOTP/InputOTPSeparator.razor" }),
        ["resizable"] = new("resizable", "Split-pane resizable layout panels", Array.Empty<string>(), new[] { "Resizable/ResizablePanelGroup.razor", "Resizable/ResizablePanel.razor", "Resizable/ResizableHandle.razor", "Resizable/ResizableOrientation.cs" })
    };
}
